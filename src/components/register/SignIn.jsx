...
function SignIn({ setSignIn }) {
  ...
  return (
    <div className="w-full h-full flex sm:flex-row flex-col justify-center items-center overflow-hidden">
      <motion.div
        className="sm:w-3/5 sm:h-full w-full h-2/5 bg-gray-800 sm:rounded-s-xl sm:rounded-se-none rounded-ss-xl rounded-se-xl flex flex-col justify-center items-center"
        initial={{
          opacity: 0,
          clipPath: `polygon(0 100%, 0 100%, 70% 100%, 0 100%)`,
        }}
        animate={{
      ...
      >
        <form
          ...
          className="w-full h-full lg:p-4 p-2 main-font flex justify-center items-center flex-col"
        >
